...
void GameMap::createMap(int x)
{
	...
	rowTwo.push_back(new GameCell(32, 32, "images/floor-cobblestone-3.png", false, false));
	rowTwo.push_back(new GameCell(64, 32, "images/floor-cobblestone-3.png", false, false));
	rowTwo.push_back(new GameCell(96, 32, "images/floor-cobblestone-3.png", false, false));
	rowTwo.push_back(new GameCell(128, 32, "images/floor-cobblestone-3.png", false, false));
	rowTwo.push_back(new GameCell(160, 32, "images/floor-cobblestone-3.png", false, false));
	...
	rowThree.push_back(new GameCell(608, 64, "images/brick-basic-green.png", false, false));
	...
	rowTwenty.push_back(new GameCell(192 + (x * 32), 608, "images/brick-basic-green.png", false, false));
